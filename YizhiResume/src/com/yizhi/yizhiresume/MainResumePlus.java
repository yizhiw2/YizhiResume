...
public class MainResumePlus extends Activity implements OnItemClickListener,
		Fragment06.Callback06 {
	...
	private void findView() {
		...
		// 选择adapter设置抽屉栏内容
		mDrawerList.setAdapter(new SimpleAdapter(MainResumePlus.this,
				listItems, R.layout.drawer_listview, new String[] { "image",
						"title" }, new int[] { R.id.image, R.id.title }));
	...
	public void onButtonClick(View v) {
		// TODO Auto-generated method stub
		String phone_number = getResources().getString(R.string.phone_number);
		String email_address = getResources().getString(R.string.email_address);
		String email_subject = getResources().getString(R.string.email_subject);
		String name = getResources().getString(R.string.name);
		String qq_number = getResources().getString(R.string.qq_number);
		...
		case R.id.saveto:
			...
			if (addSuccess == true)
				Toast.makeText(MainResumePlus.this, "已添加到联系人", 1000).show();
			break;
		default:
			break;
		}
	...
	// 保存到联系人
	private void addContact(Context context, String name, String qq,
